      ...
      <LayoutHome location={this.props.location}>
        <section className="text-container--resume">
          <div className="container--col">
            <h3>Resume</h3>
            <p>
              Call it a resume or milestone timeline. See what kept me busy the
              past years. Or directly
            ...
            <div className="resume--item">
              ...
              <p className="resume--item__text">
                ...
                started a research with an innovative Dutch bank named
            ...
            <div className="resume--item">
              ...
              <p className="resume--item__text">
                ...
                far, very far. But decided to study Communication and Multimedia
                Design in Amsterdam instead and the startup-life ended.
              </p>
            </div>
            <div className="resume--item">
              <span className="resume--item__year">2015</span>
            ...
            <div className="resume--item">
              ...
              <p className="resume--item__text">
                ...
                anything that was digital. First by myself and later, depending
                on the projects, we grew flexible to 4 freelancers.
              </p>
            </div>
            <div className="resume--item">
              <span className="resume--item__year">2014</span>
