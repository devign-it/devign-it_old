                    ...
                    <div className="container--col">
                        ...
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                UX Engineer at
                                <a href="https://dav.network">DAV Foundation</a> in Tel
                                Aviv creating decentralized transportation applications.
                            </p>
                        </div>
                        <div className="resume--item">
                            <span className="resume--item__year">2018</span>
                        ...
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                ...
                                . Can open electronic doors (of a Tesla if I've got one),
                                get free coffee at the university and scan my
                                businesscard. Also started a research with an innovative
                                Dutch bank named
                                <span className="blurryboy">NDA's signed</span>
                        ...
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                ...
                                . A shortlist with the most inspiring under 25’s across
                                the fields of digital hustlers from The Next Web.
                            </p>
                        </div>
                        <div className="resume--item">
                            <span className="resume--item__year">2017</span>
                            <p className="resume--item__text">
                                ...
                                Entrepreneurship pre-master at the Business Academy
                                Aarhus, Denmark.
                            </p>
                        </div>
                        <div className="resume--item">
                        ...
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                Co-founded a startup called Releasium in B.Amsterdam. We
                                got far, very far. But decided to study Communication and
                                Multimedia Design in Amsterdam instead and the
                                startup-life ended.
                            </p>
                        </div>
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                ...
                                one of the first Kickstarter project in the Netherlands.
                                The goal was 150 euros, I failed and drank the leftover
                                beers.
                            </p>
                        </div>
                        <div className="resume--item">
                            ...
                            <p className="resume--item__text">
                                Started DVDZ.Design, my first company and the perfect job
                                next to my study. Offering website development and and
                                almost anything that was digital. First by myself and
                                later, depending on the projects, we grew flexible to 4
                                freelancers.
                            </p>
                        </div>
                        <div className="resume--item">
                            <span className="resume--item__year">2014</span>
                            <p className="resume--item__text">
                                Received a golden dot award with Catmatch; Tinder for
                                asylum cats.
                            </p>
                        </div>
                    </div>
